...
my_Ne=input_classes.Number_Density(ID='LOCUST_IO sample Ne profile',data_format='ASCII',filename='sample_ne_profile.file',properties='electrons')

#see what it looks like
plot_input.plot_number_density(my_Ne)

#read in the sample output data
my_orbits=output_classes.Orbits(ID='LOCUST_IO sample orbits',data_format='ASCII',filename='sample_orbits.file')

#plot particle 0's trajectory in the R,Z plane
plot_output.plot_orbits(my_orbits)
