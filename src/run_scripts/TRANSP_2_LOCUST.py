...
def TRANSP_2_LOCUST(run_ID,shot_number,path_LOCUST=pathlib.Path(''),path_TRANSP=pathlib.Path(''),beam_depo_GC=True,beam_depo_number=None,GEQDSKFIX=0,beam_depo_weighted=True,tag=''):
    """
...
if __name__=='__main__':
    ...
    #convert 
    TRANSP_2_LOCUST(run_ID=args.run_ID,shot_number=args.shot_number,path_LOCUST=path_LOCUST,path_TRANSP=path_TRANSP,beam_depo_GC=args.beam_depo_GC,beam_depo_number=args.beam_depo_number,GEQDSKFIX=args.GEQDSKFIX,beam_depo_weighted=args.beam_depo_weighted,tag=args.tag)
