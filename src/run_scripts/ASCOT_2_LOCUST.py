...
def ASCOT_2_LOCUST(path_LOCUST=pathlib.Path(''),path_ASCOT=pathlib.Path(''),beam_depo_GC=True,filename_ASCOT_equilibrium='ASCOT_GEQDSK',GEQDSKFIX=0,species_numbers=[1],wall_type='2D',tag=''):
    """
