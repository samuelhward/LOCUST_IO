...
PHI_SHIFT=180
k = 1
PHI_MARS = n_ASCOT*(phic_ASCOT-PHI_ASCOT)-PHI_SHIFT+360*k #so this is essentialy ~ -(PHI_ASCOT-phic_ASCOT) i.e. the phase shift relative to first coil, then Yueqiang just adds a constant phase shift to move the origin
