...
target_IDS_dispatch['ITER_7d5MAHalfB_case2']['03'][None]['sheet_name_rotation']='Pr=0.3'
target_IDS_dispatch['ITER_7d5MAHalfB_case2']['03'][None]['var_name_rotation']=None
target_IDS_dispatch['ITER_7d5MAFullB_case3']={} 
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']={} 
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['2']={}
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['2']['shot']=131019
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['2']['run']=0
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['2']['sheet_name_kinetic_prof']='iterDD.iterFSBMI'
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['2']['sheet_name_rotation']='Pr=0.3'
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['2']['var_name_rotation']='Vt(ttor/tE=2)'
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['1']={}
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['1']['shot']=131019
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['1']['run']=1
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['1']['sheet_name_kinetic_prof']='iterDD.iterFSBMI'
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['1']['sheet_name_rotation']='Pr=0.3'
target_IDS_dispatch['ITER_7d5MAFullB_case3']['03']['1']['var_name_rotation']='Vt(ttor/tE=1)'
...
config_beam_dispatch['on']['on']['hydrogen']={}
config_beam_dispatch['on']['on']['hydrogen']['shot']=44
config_beam_dispatch['on']['on']['hydrogen']['run']=555
config_beam_dispatch['on']['on']['hydrogen']['imasdb']='ITER_MD'
config_beam_dispatch['on']['on']['hydrogen']['user']='public'
config_beam_dispatch['on']['on']['deuterium']={}
config_beam_dispatch['on']['on']['deuterium']['shot']=45
config_beam_dispatch['on']['on']['deuterium']['run']=555
config_beam_dispatch['on']['on']['deuterium']['imasdb']='ITER_MD'
config_beam_dispatch['on']['on']['deuterium']['user']='public'
config_beam_dispatch['off']={}
config_beam_dispatch['off']['off']={}
config_beam_dispatch['off']['off']['hydrogen']={}
config_beam_dispatch['off']['off']['hydrogen']['shot']=44
config_beam_dispatch['off']['off']['hydrogen']['run']=222
config_beam_dispatch['off']['off']['hydrogen']['imasdb']='ITER_MD'
config_beam_dispatch['off']['off']['hydrogen']['user']='public'
config_beam_dispatch['off']['off']['deuterium']={}
config_beam_dispatch['off']['off']['deuterium']['shot']=45
config_beam_dispatch['off']['off']['deuterium']['run']=222
config_beam_dispatch['off']['off']['deuterium']['imasdb']='ITER_MD'
config_beam_dispatch['off']['off']['deuterium']['user']='public'
config_beam_dispatch['off']['on']={}
config_beam_dispatch['off']['on']['hydrogen']={}
config_beam_dispatch['off']['on']['hydrogen']['shot']=44
config_beam_dispatch['off']['on']['hydrogen']['run']=333
config_beam_dispatch['off']['on']['hydrogen']['imasdb']='ITER_MD'
config_beam_dispatch['off']['on']['hydrogen']['user']='public'
config_beam_dispatch['off']['on']['deuterium']={}
config_beam_dispatch['off']['on']['deuterium']['shot']=45
config_beam_dispatch['off']['on']['deuterium']['run']=333
config_beam_dispatch['off']['on']['deuterium']['imasdb']='ITER_MD'
...
config_beam_dispatch['test']['test']['deuterium']['shot']=130011 #this is a deuterium heating beam
config_beam_dispatch['test']['test']['deuterium']['run']=1
config_beam_dispatch['test']['test']['deuterium']['imasdb']='ITER'
config_beam_dispatch['test']['test']['deuterium']['user']='public'

config_beam_1_default='on'
config_beam_2_default='on'
config_beam_species_default='deuterium'
config_beam_1=config_beam_1_default #can override this in run_scripts
config_beam_2=config_beam_2_default
config_beam_species=config_beam_species_default
