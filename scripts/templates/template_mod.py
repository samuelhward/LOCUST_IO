...
config_beam_dispatch['on']['on']['H']={}
config_beam_dispatch['on']['on']['H']['shot']=44
config_beam_dispatch['on']['on']['H']['run']=555
config_beam_dispatch['on']['on']['H']['imasdb']='ITER_MD'
config_beam_dispatch['on']['on']['H']['user']='public'
config_beam_dispatch['on']['on']['D']={}
config_beam_dispatch['on']['on']['D']['shot']=45
config_beam_dispatch['on']['on']['D']['run']=555
config_beam_dispatch['on']['on']['D']['imasdb']='ITER_MD'
config_beam_dispatch['on']['on']['D']['user']='public'
config_beam_dispatch['off']={}
config_beam_dispatch['off']['off']={}
config_beam_dispatch['off']['off']['H']={}
config_beam_dispatch['off']['off']['H']['shot']=44
config_beam_dispatch['off']['off']['H']['run']=222
config_beam_dispatch['off']['off']['H']['imasdb']='ITER_MD'
config_beam_dispatch['off']['off']['H']['user']='public'
config_beam_dispatch['off']['off']['D']={}
config_beam_dispatch['off']['off']['D']['shot']=45
config_beam_dispatch['off']['off']['D']['run']=222
config_beam_dispatch['off']['off']['D']['imasdb']='ITER_MD'
config_beam_dispatch['off']['off']['D']['user']='public'
config_beam_dispatch['off']['on']={}
config_beam_dispatch['off']['on']['H']={}
config_beam_dispatch['off']['on']['H']['shot']=44
config_beam_dispatch['off']['on']['H']['run']=333
config_beam_dispatch['off']['on']['H']['imasdb']='ITER_MD'
config_beam_dispatch['off']['on']['H']['user']='public'
config_beam_dispatch['off']['on']['D']={}
config_beam_dispatch['off']['on']['D']['shot']=45
config_beam_dispatch['off']['on']['D']['run']=333
config_beam_dispatch['off']['on']['D']['imasdb']='ITER_MD'
config_beam_dispatch['off']['on']['D']['user']='public'
config_beam_dispatch['diagnostic']={}
config_beam_dispatch['diagnostic'][None]={}
config_beam_dispatch['diagnostic'][None]['D']={}
config_beam_dispatch['diagnostic'][None]['D']['shot']=IDS__shot
config_beam_dispatch['diagnostic'][None]['D']['run']=IDS__run+1 #just fill the adjacent run when generating our own NBI
config_beam_dispatch['diagnostic'][None]['D']['imasdb']=IDS__imasdb
config_beam_dispatch['diagnostic'][None]['D']['user']=IDS__username
config_beam_dispatch['test']={}
config_beam_dispatch['test']['test']={}
config_beam_dispatch['test']['test']['shot']=130011 #this is a deuterium heating beam
