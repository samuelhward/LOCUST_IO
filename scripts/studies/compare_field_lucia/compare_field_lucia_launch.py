#compare_field_lucia_launch.py
 
"""
Samuel Ward
24/07/21
----
compare against Lucia case 1 field at phi_mars=200,0,140

flip toroidal component of perturbation, and compare poincare maps/plasma response
---
...
RMP_study__name='compare_field_lucia'
...
parameters__plasma_responses=['plasma_response','vacuum']

parameters__toroidal_mode_numbers=[[-3],[-3],[3],[3]]
parameters__i3drs=[-1,1,1,-1]

parameters__phases_uppers=np.array([0.])-200./3.
parameters__phases_middles=np.array([0.])+0./3.      
parameters__phases_lowers=np.array([0.])-140./3.
...
RMP_study__workflow_commands="\"['mkdir','save_args','kin_get','3D_get','3D_calc','input_get','IDS_create','run_BBNBI','depo_get','calc_poinc','run_LOCUST']\""
...
for parameters__database,parameters__sheet_name_kinetic_prof in zip(
    ...
    for parameters__kinetic_prof_tF_tE,parameters__kinetic_prof_Pr in zip(parameters__kinetic_profs_tF_tE,parameters__kinetic_profs_Pr):
        ...
        for parameters__plasma_response in parameters__plasma_responses:
            for parameters__toroidal_mode_number,parameters__i3dr in zip(parameters__toroidal_mode_numbers,parameters__i3drs):
                for parameters__phase_upper,parameters__phase_middle,parameters__phase_lower in zip(parameters__phases_uppers,parameters__phases_middles,parameters__phases_lowers):
                    for parameters__rotation_upper,parameters__rotation_middle,parameters__rotation_lower in zip(parameters__rotations_upper,parameters__rotations_middle,parameters__rotations_lower): #nest at same level == rotating them together rigidly
                        for parameters__current_upper,parameters__current_middle,parameters__current_lower in zip(parameters__currents_upper,parameters__currents_middle,parameters__currents_lower):
                            ...
                            parameters__parameter_string+='i3dr_'
                            parameters__parameter_string+='{}_'.format(str(parameters__i3dr)) #add i3dr switch    
                            parameters__parameter_string+='{}_'.format(parameters__plasma_response) #add plasma response type    
                            ...
                            LOCUST_run__settings_prec_mod['i3dr']=parameters__i3dr #XXX WHILST I3DR FLAG IS BROKE
                            ...
                            RMP_study__field_type=parameters__plasma_response #response or vacuum
