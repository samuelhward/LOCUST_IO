...
parameters__phases_upper=np.linspace(-10,140,16) #first value is for axisymmetric simulation
parameters__phases_middle=np.linspace(-10,140,16)
parameters__phases_lower=np.linspace(-10,140,16)
