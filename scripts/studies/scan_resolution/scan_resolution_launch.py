...
RMP_study__workflow_commands="\"['mkdir','save_args','kin_get','3D_get','3D_calc','input_get','calc_divB','IDS_create','kin_extrap','run_BBNBI','depo_get','run_LOCUST','clean_input']\""
