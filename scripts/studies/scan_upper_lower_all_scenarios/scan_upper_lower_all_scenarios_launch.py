#scan_upper_lower_all_scenarios_launch.py
...
study to find whether XPD correlates with fast-ion losses across scenarios (will justify 2/3 studies i.e. studies_simon)

use single harmonic (remember to change IN_IC)
---
...
RMP_study__name='scan_upper_lower_all_scenarios'
...
#kinetic profile parameters which vary with above
parameters__kinetic_profs_Pr=[0.3,0.3,0.3,0.3]#,1.] #pick highest then lowest rotation
parameters__kinetic_profs_tF_tE=[2.,2.,2.,2.]#,0.5]
...
for parameters__database,parameters__sheet_name_kinetic_prof,config_beam_species,plasma_species,parameters__kinetic_prof_tF_tE,parameters__kinetic_prof_Pr in zip(parameters__databases,parameters__sheet_names_kinetic_prof,configs_beam_species,plasmas_species,parameters__kinetic_profs_tF_tE,parameters__kinetic_profs_Pr): 
    for parameters__toroidal_mode_number,parameters__phases_upper,parameters__phases_middle,parameters__phases_lower in zip(
        parameters__toroidal_mode_numbers,parameters__phases_uppers,parameters__phases_middles,parameters__phases_lowers):
