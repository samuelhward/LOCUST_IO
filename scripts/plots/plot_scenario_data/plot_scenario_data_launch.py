#plot_scenario_data_launch.py
 
"""
Samuel Ward
27/09/21
----
script for generating all types of input scenario data including beam depositions
---
...
RMP_study__name='plot_scenario_data'
...
parameters__phases_uppers_case2=[0]
parameters__phases_middles_case2=[0]
parameters__phases_lowers_case2=[0]

parameters__phases_uppers_case3=[0]
parameters__phases_middles_case3=[0]
parameters__phases_lowers_case3=[0]

parameters__phases_uppers_case5=[0]
parameters__phases_middles_case5=[0]
parameters__phases_lowers_case5=[0]

parameters__phases_uppers_case7=[0]
...
parameters__currents_upper=np.array([0.])
