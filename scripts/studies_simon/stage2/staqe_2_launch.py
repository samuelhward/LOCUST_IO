...
parameters__phases_uppers=[np.array([np.linspace(0,120,7)[:-1][0]+30.+200./3.]),np.array([np.linspace(0,90,7)[:-1][4]+30.+250./4.])]
parameters__phases_middles=[np.array([np.linspace(0,120,7)[:-1][0]+26.7+0./3.]),np.array([np.linspace(0,90,7)[:-1][4]+26.7+0./4.])]
parameters__phases_lowers=[np.array([np.linspace(0,120,7)[:-1][0]+30.+140./3.]),np.array([np.linspace(0,90,7)[:-1][4]+30.+95./4.])]
parameters__rotations_upper=np.array([0.])
parameters__rotations_middle=np.array([0.])
parameters__rotations_lower=np.array([0.])

parameters__currents_upper=np.array([15.,30.,60.,90.])*1000. #first value is for axisymmetric case
parameters__currents_middle=copy.deepcopy(parameters__currents_upper)
parameters__currents_lower=copy.deepcopy(parameters__currents_upper)
...
RMP_study__workflow_commands="\"['mkdir','save_args','kin_get','3D_get','3D_calc','input_get','IDS_create','run_BBNBI','depo_get','calc_divB','calc_poinc','run_LOCUST','clean_input']\""
