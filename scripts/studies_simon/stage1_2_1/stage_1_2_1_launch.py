...
stage 1.2.1
    ...
    - fix IN_IC=1 in mars_read (requires manual editing of mars_read.f90)
    - fix n=3 + no sideband
    - remove -DNOTUNE LOCUST flag
...
parameters__phases_uppers=[np.linspace(0,120,7)[:-1]+30.+200./3.]
parameters__phases_middles=[np.linspace(0,120,7)[:-1]+26.7+0./3.]
parameters__phases_lowers=[np.linspace(0,120,7)[:-1]+30.+140./3.]
