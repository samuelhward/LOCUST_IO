...
# set label fontsize via colorbar editor (size 20)
#
#
#
...
simulations=[
    ...
    #'*-?_-?_phaseu_*_phasem_10?.*_phasel_*90000*', #angle with worst pipe power loads for n=3+6 and n=4+5
...
opacityMap.RescaleTransferFunction(0.0001, 1)
opacityMap.Points=[
    0.,0.000,0.5,0.,
    0.003,1.,0.5,0.,
    1.,1.,0.5,0.,
...
layout=GetLayout()
SaveScreenshot("1_10_1_60kaT_n=3_6_wall_heatloads_1.png",ImageResolution=[1892, 762],layout=layout)
