...
stage 1.3
    ...
    - start with best phases (X-point displacement) from table 2 (Yueqiang) (now measured from coil centres)
    - fix relative coil phase 
    - fix Pr=0.3 and τφ/τE=2.
    - fix n=3 + sideband
    - vary absolute toroidal phase over two wavelengths in ITER system
    - 10 runs
---
...
parameters__phases_uppers=[np.linspace(0,240,11)[:-1]+30.+200./3.]
parameters__phases_middles=[np.linspace(0,240,11)[:-1]+26.7+0./3.]
parameters__phases_lowers=[np.linspace(0,240,11)[:-1]+30.+140./3.]
