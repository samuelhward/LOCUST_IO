...
# case 2, n=3: 1st point 
# case 2, n=4: 4th point
# case 3, n=3: 4th point 
# case 3, n=4: 3rd point 
...
parameters__phases_uppers_case3=[
    ...
    contour_relative_phase_upper_case3_n4+np.linspace(0,90,6)[:-1][2]+30.-3.3]
parameters__phases_middles_case3=[
    np.full(len(contour_relative_phase_upper_case3_n3),np.linspace(0,120,6)[:-1][3])+26.7,
    np.full(len(contour_relative_phase_upper_case3_n4),np.linspace(0,90,6)[:-1][2])+26.7]
parameters__phases_lowers_case3=[
    contour_relative_phase_lower_case3_n3+np.linspace(0,120,6)[:-1][3]+30.-3.3,
    contour_relative_phase_lower_case3_n4+np.linspace(0,90,6)[:-1][2]+30.-3.3]
...
parameters__currents_upper=np.array([67.5])*1000.
parameters__currents_middle=np.array([67.5])*1000.
parameters__currents_lower=np.array([67.5])*1000.
