...
parameters__phases_lowers = [
    np.array([75.0, 167.8797372399381, 243.0224383846416, 269.33915048282586, 203.18397667399648, 110.31083349576636, 35.175600056809, 8.854857448075652])/3.+30-3.3,
    np.array([30.0, 120.09213962358345, 191.14556644140822, 219.08551613857986, 159.15659320240238, 69.06617432444777, -1.994981193681455, -29.924349163320883])/4.+30-3.3
    ]
