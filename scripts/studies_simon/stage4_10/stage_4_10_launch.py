...
parameters__phases_uppers_case7=[np.linspace(0,120,6)[:-1]+30.-290./3.-3.3,np.linspace(0,90,6)[:-1]+30.-0./4.-3.3] #original phases
#parameters__phases_uppers_case7=[np.linspace(0,120,6)[:-1]+30.-295./3.-3.3,np.linspace(0,90,6)[:-1]+30.-0./4.-3.3] #updated phases - Yueqiang uses -290,-50 for n=3
...
parameters__currents_upper=np.array([30.])*1000.
parameters__currents_middle=np.array([30.])*1000.
parameters__currents_lower=np.array([30.])*1000.
