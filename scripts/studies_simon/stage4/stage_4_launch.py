...
stage 4 
    ...
    - vary 7.5MA/2.65T hydrogen/Hbeam (case 2) and 7.5MA/5.3T (case 3) deuterium-deuterium/Dbeam scenarios
...
parameters__phases_uppers_case2=[np.linspace(0,120,6)[:-1]+30.+190./3.-3.3,np.linspace(0,90,6)[:-1]+30.+230./4.-3.3]
parameters__phases_middles_case2=[np.linspace(0,120,6)[:-1]+26.7+0./3.,np.linspace(0,90,6)[:-1]+26.7+0./4.]
parameters__phases_lowers_case2=[np.linspace(0,120,6)[:-1]+30.+145./3.-3.3,np.linspace(0,90,6)[:-1]+30.+75./4.-3.3]

parameters__phases_uppers_case3=[np.linspace(0,120,6)[:-1]+30.+330./3.-3.3,np.linspace(0,90,6)[:-1]+30.+215./4.-3.3]
...
parameters__phases_uppers_cases_all=[parameters__phases_uppers_case2,parameters__phases_uppers_case3]
parameters__phases_middles_cases_all=[parameters__phases_middles_case2,parameters__phases_middles_case3]
parameters__phases_lowers_cases_all=[parameters__phases_lowers_case2,parameters__phases_lowers_case3]
